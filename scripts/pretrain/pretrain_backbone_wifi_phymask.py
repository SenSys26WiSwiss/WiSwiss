...
def main(args):
    ...
    checkpoint_dir = os.path.join(args.checkpoint_root_dir, \
        f'{phymask_name}_{dfs_name}_{rope_name}_{patch_name}_{args.model_size}_mask{args.mask_ratio}{mask_name}_{data_name}_{bs_name}_lr{args.lr}_{CURRENT_TIME}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mmfi_subset_indices_path', type=str)
    ...
    # DFS parameters
    parser.add_argument('--dfs_weight', type=float, default=0, help='Weight for DFS loss.')
    ...
    # log parameters
    parser.add_argument('--checkpoint_root_dir', type=str, default='pretrain_phymask_checkpoints_v2', help='Path to the directory to save checkpoints.')
