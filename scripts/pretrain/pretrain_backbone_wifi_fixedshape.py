...
def main(args):
    ...
    checkpoint_dir = os.path.join(args.checkpoint_root_dir, \
        f'{args.fixed_shape[0]}x{args.fixed_shape[1]}_{dfs_name}_{patch_name}_{args.model_size}_mask{args.mask_ratio}{mask_name}_{data_name}_{bs_name}_lr{args.lr}_{CURRENT_TIME}')
...
if __name__ == '__main__':
    ...
    # log parameters
    parser.add_argument('--checkpoint_root_dir', type=str, default='pretrain_fixedshape_checkpoints', help='Path to the directory to save checkpoints.')
