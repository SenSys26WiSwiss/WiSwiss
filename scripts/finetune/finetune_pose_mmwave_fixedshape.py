...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        checkpoint_dir = os.path.join(args.checkpoint_root_dir, \
            f'{args.prefix_name}_{args.model_size}_{fixed_shape_name}_{patch_name}_{shape_name}_{lr_name}_{CURRENT_TIME}')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--fixed_shape', type=lambda s: [int(x) for x in s.split(',')], default=[64, 256, 256])
