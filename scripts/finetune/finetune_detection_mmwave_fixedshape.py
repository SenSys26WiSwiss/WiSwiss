...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        checkpoint_dir = os.path.join(args.checkpoint_root_dir, \
            f'{args.prefix_name}_{args.model_size}_{iou_name}_{fixed_shape_name}_{patch_name}_{shape_name}_{lr_name}_{CURRENT_TIME}')
    ...
    model = FixedViTModel(patch_size=args.patch_size, patch_stride=args.patch_stride, 
                         ...
                         train_stage=1, task_type=1, num_anchors=len(anchors),
